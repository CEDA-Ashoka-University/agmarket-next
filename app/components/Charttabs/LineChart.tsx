...
const LineChart: React.FC<LineChartProps> = ({ PriceData, QtyData }) => {
  ...
  // Function to download SVG as JPEG
  // const handleDownloadChart = () => {
  //   console.log("handleDownloadChart clicked");
  ...
  //   canvas.width = WIDTH + MARGINS.LEFT + MARGINS.RIGHT;
  //   canvas.height = HEIGHT + MARGINS.TOP + MARGINS.BOTTOM + 50;
  ...
  //       scale: 2, // Increase the resolution of the output image
  //     });

  //     const image = canvas.toDataURL("image/jpeg", 1.0);
  //     const link = document.createElement("a");
  //     link.href = image;
  //     link.download = "chart_with_tabs.jpg";
  //     link.click();
  //   } catch (error) {
